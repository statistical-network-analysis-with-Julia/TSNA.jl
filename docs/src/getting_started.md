...
Compute snapshot measures, follow time-respecting paths, and summarize durations on one constructed dynamic network. Then work with contact sequences and aggregation, keeping temporal reachability separate from an assumed diffusion mechanism.
